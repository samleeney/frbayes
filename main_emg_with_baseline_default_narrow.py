...
def main():
    ...
    global_settings._load_settings(settings_file="settings_emg_with_baseline_default_narrow.yaml")
    ...
    model_ = global_settings.get("model", "emg_with_baseline") # Default to "emg" if not specified
