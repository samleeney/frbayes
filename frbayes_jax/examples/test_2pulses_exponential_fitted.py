...
def main():
    ...
    plt.savefig('results/test_2pulses_exponential_fitted_data.png', dpi=150, bbox_inches='tight')
    plt.close()
    print("Data plot saved to results/test_2pulses_exponential_fitted_data.png")
    ...
    output_dir = f"results/results_2pulses_exponential_fitted_{timestamp}"
