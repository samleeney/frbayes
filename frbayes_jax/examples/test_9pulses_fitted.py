...
def main():
    ...
    plt.tight_layout()
    plt.savefig('results/test_9pulses_fitted_data.png', dpi=150, bbox_inches='tight')
    plt.close()
    print("Data plot saved to results/test_9pulses_fitted_data.png")
    ...
    output_dir = f"results/results_9pulses_fitted_{timestamp}"
