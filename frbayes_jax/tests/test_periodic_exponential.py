...
def main():
    ...
    plt.savefig('test_periodic_exponential_data.png', dpi=150, bbox_inches='tight')
    plt.close()
    print("Data plot saved to test_periodic_exponential_data.png")
    ...
    output_dir = "results_periodic_exponential"
