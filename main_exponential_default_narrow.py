...
def main():
    ...
    global_settings._load_settings(settings_file="settings_exponential_default_narrow.yaml")
    ...
    model_ = global_settings.get("model", "exponential") # Default to "emg" if not specified
